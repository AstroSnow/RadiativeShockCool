...
beta_arr=[1.0,0.1,0.01,0.001]
theta_arr=[3.14/2.0,3.14/4.0,3.14/8.0,3.14/16.0]
#beta=0.1
#theta=3.14/8.0
#T0=tlf[np.argmax(lf)]
T0=1.0e6
...
for beta in beta_arr:
    for theta in theta_arr:
        print('Chianti_param_beta_'+'{0:.3f}'.format(beta)+'_theta_'+'{0:.3f}'.format(theta)+'.h5')
        a2d=[]
        ...
        #Save the data
        hf = h5py.File('Chianti_param_beta_'+'{0:.3f}'.format(beta)+'_theta_'+'{0:.3f}'.format(theta)+'.h5', 'w')
